...
| `maxPlayers`   | Ориентир вместимости стола, обычно `9` для 9-max. |
...
| -------------- | ---------------- | ------------ | --------------------------------------------------------------------------------------------------------- |
| `playersCount` | `number`         | Нет          | Целое число, минимум `0`; может быть больше `maxPlayers`.                                                 |
| `maxPlayers`   | `number`         | Нет          | Целое число, минимум `1`; используется как ориентир вместимости, не как жесткий лимит.                    |
