...
списках события отображаются только участники с `arrived: true` и статусом не
`CANCELLED`. Участники с `arrived: false` или `status: "CANCELLED"` остаются в
списке участников события, но не отображаются в оплатах, долгах, промо, баре,
турнире, финальном столе и shift dashboard.
